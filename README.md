...
- **Sep. 26th, 2024**: Provide a project plan (refer to [project-plan-template.md](project-plan-template.md))
- **Sep. 27th - Oct. 7th**: Work on your project in class (and outside of class)
    - Usual class times are for office hours to discuss any issues you have
- **Oct. 8th**: Project submission
- **Oct. 8th**: 8 minute presentation of your project
